...
class Voteps extends CI_Controller {
	...
	public function voteDesktop(){
		...
		$this->load->view('ps-vote-desktop');
	}

	public function voteMobile(){
		$this->load->helper('recaptchalib_helper');
		$this->load->view('ps-vote-mobile');
	}
	...
	public function envia(){
		if($_POST['cat']){
			...
			// ITERACAO COM QUANTIDADE DE CATEGORIAS DO PREMIO
				$curl_data = '{"pdRequest": {
				    "partnerGUID": "7381bf0e-95f9-f549-9228-00003062052b",
				    "userCode": "'.$usercode.'",
				    "demands": {
...
/* End of file voteps.php */
/* Location: ./application/controllers/voteps.php */